...
public class TouchImageView3 extends ImageView {
    ...
    private class DoubleTapZoom implements Runnable {
        ...
        DoubleTapZoom(float targetZoom, float focusX, float focusY, boolean stretchImageToSuper) {
            TouchImageView3.this.setState(State.ANIMATE_ZOOM);
            this.startTime = System.currentTimeMillis();
            this.startZoom = TouchImageView3.this.normalizedScale;
            this.targetZoom = targetZoom;
            this.stretchImageToSuper = stretchImageToSuper;
            PointF bitmapPoint = TouchImageView3.this.transformCoordTouchToBitmap(focusX, focusY, false);
            this.bitmapX = bitmapPoint.x;
            this.bitmapY = bitmapPoint.y;
            this.startTouch = TouchImageView3.this.transformCoordBitmapToTouch(this.bitmapX, this.bitmapY);
            this.endTouch = new PointF((float) (TouchImageView3.this.viewWidth / 2), (float) (TouchImageView3.this.viewHeight / 2));
        }

        public void run() {
            float t = interpolate();
            TouchImageView3.this.scaleImage(calculateDeltaScale(t), this.bitmapX, this.bitmapY, this.stretchImageToSuper);
            translateImageToCenterTouchPosition(t);
            TouchImageView3.this.fixScaleTrans();
            TouchImageView3.this.setImageMatrix(TouchImageView3.this.matrix);
            if (TouchImageView3.this.touchImageViewListener != null) {
                TouchImageView3.this.touchImageViewListener.onMove();
            }
            if (t < 1.0f) {
                TouchImageView3.this.compatPostOnAnimation(this);
            } else {
                TouchImageView3.this.setState(State.NONE);
            }
        }
        ...
        private void translateImageToCenterTouchPosition(float t) {
            ...
            PointF curr = TouchImageView3.this.transformCoordBitmapToTouch(this.bitmapX, this.bitmapY);
            TouchImageView3.this.matrix.postTranslate(targetX - curr.x, targetY - curr.y);
        }
        ...
        private double calculateDeltaScale(float t) {
            return ((double) (this.startZoom + ((this.targetZoom - this.startZoom) * t))) / ((double) TouchImageView3.this.normalizedScale);
        }
    }
    ...
    private class Fling implements Runnable {
        ...
        Fling(int velocityX, int velocityY) {
            ...
            int minY;
            int maxY;
            TouchImageView3.this.setState(State.FLING);
            this.scroller = new CompatScroller(TouchImageView3.this.context);
            TouchImageView3.this.matrix.getValues(TouchImageView3.this.m);
            int startX = (int) TouchImageView3.this.m[2];
            int startY = (int) TouchImageView3.this.m[5];
            if (TouchImageView3.this.getImageWidth() > ((float) TouchImageView3.this.viewWidth)) {
                minX = TouchImageView3.this.viewWidth - ((int) TouchImageView3.this.getImageWidth());
                maxX = 0;
            } else {
                maxX = startX;
                minX = startX;
            }
            if (TouchImageView3.this.getImageHeight() > ((float) TouchImageView3.this.viewHeight)) {
                minY = TouchImageView3.this.viewHeight - ((int) TouchImageView3.this.getImageHeight());
                maxY = 0;
            } else {
                maxY = startY;
                minY = startY;
        ...
        public void run() {
            ...
            if (this.scroller.isFinished()) {
                ...
                this.currX = newX;
                this.currY = newY;
                TouchImageView3.this.matrix.postTranslate((float) transX, (float) transY);
                TouchImageView3.this.fixTrans();
                TouchImageView3.this.setImageMatrix(TouchImageView3.this.matrix);
                TouchImageView3.this.compatPostOnAnimation(this);
            }
        }
    ...
    private class GestureListener extends SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (TouchImageView3.this.doubleTapListener != null) {
                return TouchImageView3.this.doubleTapListener.onSingleTapConfirmed(e);
            }
            return TouchImageView3.this.performClick();
        }

        public void onLongPress(MotionEvent e) {
            TouchImageView3.this.performLongClick();
        }

        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (TouchImageView3.this.fling != null) {
                TouchImageView3.this.fling.cancelFling();
            }
            TouchImageView3.this.fling = new Fling((int) velocityX, (int) velocityY);
            TouchImageView3.this.compatPostOnAnimation(TouchImageView3.this.fling);
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if (TouchImageView3.this.doubleTapListener != null) {
                consumed = TouchImageView3.this.doubleTapListener.onDoubleTap(e);
            }
            if (TouchImageView3.this.state != State.NONE) {
                return consumed;
            }
            TouchImageView3.this.compatPostOnAnimation(new DoubleTapZoom(TouchImageView3.this.normalizedScale == TouchImageView3.this.minScale ? TouchImageView3.this.maxScale : TouchImageView3.this.minScale, e.getX(), e.getY(), false));
            return true;
        }

        public boolean onDoubleTapEvent(MotionEvent e) {
            if (TouchImageView3.this.doubleTapListener != null) {
                return TouchImageView3.this.doubleTapListener.onDoubleTapEvent(e);
            }
            return false;
        }
    }
    ...
    private class PrivateOnTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            TouchImageView3.this.mScaleDetector.onTouchEvent(event);
            TouchImageView3.this.mGestureDetector.onTouchEvent(event);
            PointF curr = new PointF(event.getX(), event.getY());
            if (TouchImageView3.this.state == State.NONE || TouchImageView3.this.state == State.DRAG || TouchImageView3.this.state == State.FLING) {
                switch (event.getAction()) {
                    case 0:
                        ...
                        TouchImageView3.this.setState(State.DRAG);
                        break;
                    case 1:
                    case 6:
                        TouchImageView3.this.setState(State.NONE);
                        break;
                    case 2:
                        if (TouchImageView3.this.state == State.DRAG) {
                            float deltaY = curr.y - this.last.y;
                            TouchImageView3.this.matrix.postTranslate(TouchImageView3.this.getFixDragTrans(curr.x - this.last.x, (float) TouchImageView3.this.viewWidth, TouchImageView3.this.getImageWidth()), TouchImageView3.this.getFixDragTrans(deltaY, (float) TouchImageView3.this.viewHeight, TouchImageView3.this.getImageHeight()));
                            TouchImageView3.this.fixTrans();
            ...
            TouchImageView3.this.setImageMatrix(TouchImageView3.this.matrix);
            if (TouchImageView3.this.userTouchListener != null) {
                TouchImageView3.this.userTouchListener.onTouch(v, event);
            }
            if (TouchImageView3.this.touchImageViewListener != null) {
                TouchImageView3.this.touchImageViewListener.onMove();
            }
    ...
    private class ScaleListener extends SimpleOnScaleGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector detector) {
            TouchImageView3.this.setState(State.ZOOM);
            return true;
        }

        public boolean onScale(ScaleGestureDetector detector) {
            TouchImageView3.this.scaleImage((double) detector.getScaleFactor(), detector.getFocusX(), detector.getFocusY(), true);
            if (TouchImageView3.this.touchImageViewListener != null) {
                TouchImageView3.this.touchImageViewListener.onMove();
            }
            return true;
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            ...
            float targetZoom = TouchImageView3.this.normalizedScale;
            if (TouchImageView3.this.normalizedScale > TouchImageView3.this.maxScale) {
                targetZoom = TouchImageView3.this.maxScale;
                animateToZoomBoundary = true;
            } else if (TouchImageView3.this.normalizedScale < TouchImageView3.this.minScale) {
                targetZoom = TouchImageView3.this.minScale;
                animateToZoomBoundary = true;
            }
            if (animateToZoomBoundary) {
                TouchImageView3.this.compatPostOnAnimation(new DoubleTapZoom(targetZoom, (float) (TouchImageView3.this.viewWidth / 2), (float) (TouchImageView3.this.viewHeight / 2), true));
            }
        }
    }
    ...
    public TouchImageView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructing(context);
    }

    public TouchImageView3(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setZoom(TouchImageView3 img) {
